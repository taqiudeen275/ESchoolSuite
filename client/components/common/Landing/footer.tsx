        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-6">
                ...
                <span className="text-2xl font-bold">ESchool</span>
              </div>
              <p className="text-gray-400 mb-6 leading-relaxed">
                Empowering educational institutions with modern management solutions for better learning outcomes.
              </p>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-400">© {currentYear} ESchool. All rights reserved.</p>
